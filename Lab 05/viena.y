...
program: code25 code32 code6 code7 code4 stmtlist code5 {printf("%s\n","yacc  program statement ");};
...
input: code31 code6 code0 code7 code8 {printf("%s\n","input statement ");};
output: code30 code6 expresie code7 code8 {printf("%s\n","output statement ");};
whilestmt: code27 code6 conditie code7 code4 stmtlist code5 {printf("%s\n","while statement ");};
ifstmt: code28 code6 conditie code7 code4 stmtlist code5 | code28 code6 conditie code7 code4 stmtlist code5 code29 code4 stmtlist code5 {printf("%s\n","if statement ");} ;
